...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HIVendorManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1058695900@qq.com/HIVendorManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1058695900@qq.com' => '1058695900@qq.com' }
  s.source           = { :git => 'https://github.com/1058695900@qq.com/HIVendorManager.git', :tag => s.version.to_s }
